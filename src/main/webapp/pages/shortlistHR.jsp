...
try
{
	...
	String query="SELECT APPLICATION_ID, APPLICANT_NAME,PHONE,EMAIL FROM CANDIDATE WHERE APPLICATION_ID IN(SELECT APPLICATION_ID FROM RESULT_TECH WHERE MARKS >=70)";
