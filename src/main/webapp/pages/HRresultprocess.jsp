...
<% 
	...
	try
	{
		...
		String query="INSERT INTO RESULT_HR (APPLICATION_ID,MARKS,FEEDBACK) VALUES ('"+application_id+"','"+marks+"','"+feedback+"')";
		int rn=stmt.executeUpdate(query);
		if(rn>0)
		{
			response.sendRedirect("HRresult.jsp");	
		}
		else
		{
			response.sendRedirect("/clg_project/pages/HRresult.jsp");
		}
		con.close();
	}
	catch(Exception e)
