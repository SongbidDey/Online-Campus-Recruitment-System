...
try
{
	...
	String query="SELECT APPLICATION_ID, APPLICANT_NAME,PHONE,EMAIL FROM CANDIDATE WHERE APPLICATION_ID IN(SELECT APPLICATION_ID FROM RESULT_HR WHERE MARKS >=70)";
	rs=stmt.executeQuery(query);
	while(rs.next())
	{
		String a_id="shortlistselectionprocess.jsp?app_id="+String.valueOf(rs.getInt("APPLICATION_ID"));
